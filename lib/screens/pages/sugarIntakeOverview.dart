...
class _SugarIntakeOverviewState extends State<SugarIntakeOverview> {
  ...
  List<SugarIntakeData> _generateChartData(DateTime centerDate) {
    ...
    for (var mealEntry in mealEntries) {
      DateTime date = DateTime(mealEntry.dateTime.year,
          mealEntry.dateTime.month, mealEntry.dateTime.day);
    ...
    for (int i = -3; i <= 3; i++) {
      ...
      chartData.add(
          sugarIntakeMap[currentDate] ?? SugarIntakeData(date: currentDate));
    }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Kohlenhydrataufnahmenübersicht'),
      ),
      body: Padding(
          ...
          children: <Widget>[
            ...
            SfCartesianChart(
              ...
              primaryYAxis: NumericAxis(
                title: AxisTitle(text: 'Kohlenhydrataufnahme (g)'),
                plotBands: <PlotBand>[
                  PlotBand(
                    isVisible: true,
                    start: 281,
              ...
              series: <CartesianSeries>[
                ColumnSeries<SugarIntakeData, DateTime>(
                    ...
                    yValueMapper: (SugarIntakeData data, _) =>
                        data.totalSugarIntake,
            ...
            Padding(
              ...
              child: Text(
                "Diese Tabelle zeigt Ihre tägliche Kohlenhydrataufnahme. Der grüne Bereich markiert den sinnvollen Wertebereich.",
            ...
            Expanded(
              child: Align(
                ...
                child: ElevatedButton(
                  ...
                  child: Text("Mein Ernährungstagebuch"),
